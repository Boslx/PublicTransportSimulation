package de.hhn.it.pp.components.timetable.exceptions;

import java.security.PrivilegedActionException;

public class TransportationVehicleBusyException extends Exception {

  private static final org.slf4j.Logger logger =
      org.slf4j.LoggerFactory.getLogger(
          de.hhn.it.pp.components.exceptions.IllegalParameterException.class);

  /**
   * Constructs a new exception with {@code null} as its detail message. The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   */
  public TransportationVehicleBusyException() {
  }
   ...
   */
  public TransportationVehicleBusyException(final String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public TransportationVehicleBusyException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public TransportationVehicleBusyException(final Throwable cause) {
    super(cause);
  }
}
