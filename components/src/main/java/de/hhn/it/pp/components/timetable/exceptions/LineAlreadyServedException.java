...
public class LineAlreadyServedException extends Exception {
   ...
   */
  public LineAlreadyServedException() {
  }
   ...
   */
  public LineAlreadyServedException(final String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public LineAlreadyServedException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public LineAlreadyServedException(final Throwable cause) {
    super(cause);
  }
}
